...
const libraries = [
    { name: "@ethossoftworks/visce", directory: path.resolve(__dirname, "../../packages/interactor") },
    { name: "@ethossoftworks/visce-react", directory: path.resolve(__dirname, "../../packages/interactor-react") },
]
